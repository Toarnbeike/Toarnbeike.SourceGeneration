...
namespace Toarnbeike.SourceGeneration.Semantic.Attributes;
...
public static class AttributeDataExtensions
{
    extension(AttributeData attribute)
    {
        ...
        public T? GetConstructorArgumentValue<T>(int index = 0) =>
        ...
        public INamedTypeSymbol? GetTypeArgument(int index = 0) =>
        ...
        private TypedConstant? GetConstructorArgument(int index) =>
